        ...
        <div class="col-8 mx-auto">
            ...
            <form action="{{ route('careers.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="eligibility" id="eligibility" cols="30" rows="7" class="form-control shadow-nonw"></textarea>
                </div>

                <div class="mb-3">
                    <label for="responsibilities" class="fw-bold">Responsibilities : </label>
                    <textarea name="responsibilities" id="responsibilites" cols="30" rows="7" class="form-control shadow-nonw"></textarea>
                </div>

                <div class="mb-3">
                    <label for="location" class="fw-bold">Location </label>
                    <input type="text" name="location" id="location" class="form-control shadow-none">
                </div>

                <div class="mb-3">
                    <label for="salary" class="fw-bold">Salary</label>
                    <input type="number" name="salary" id="salary" class="form-control shadow-none">
                </div>
                ...
                <div class="mb-3 col">
                    ...
                    <input type="date" name="deadline" class="form-control shadow-none">
                </div>
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-dark btn-sm float-end">Add Career</button>
                </div>
            </form>
        </div>
    </div>

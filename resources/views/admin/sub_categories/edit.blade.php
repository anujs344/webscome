...
<div class="card border-0 rounded-10 card-shadow">
    ...
    <div class="card-body">
        <div class="col-8 mx-auto">
            ...
            <form action="{{ route('subCat.update',[$category->id]) }}" method="POST" enctype="multipart/form-data">
                <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                <div class="mb-3">
                    <label for="category" class="fw-bold">Parent Category</label>
                   
                    <select name="parent_category" id="parent_category" class="form-control shadow-none">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $category->title }}" name="category" id="category" class="form-control shadow-none">
                </div>
                ...
                <div class="mb-3">
                    <img src="/storage/cover_images_subcategory/{{ $category->image }}" alt="no image" class="img-fluid rounded-10 shadow" style="height: 200px; width:200px; object-fit:cover" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <button type="submit" class="btn btn-dark btn-sm float-end">Update Sub-Category</button>
                </div>
            </form>

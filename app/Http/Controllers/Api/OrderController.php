...
//    }
    ...
    public function make_approval($id)
    {
        ...
        // return redirect()->route('new_orders')->with();
        return response()->json(['success'=>'forwarded to professional'], 200);
...
//    }
    ...
    public function change_order_professional($order_id, $service_id,Request $request)
    {
        ...
        return response()->json(['success'=>'Professional Assignment Successfull'], 200);
    }
    ...
    public function changeorderdate(Request $request){
        ...
        return response()->json(['success'=>'Service Date updated for the placed order'], 200);

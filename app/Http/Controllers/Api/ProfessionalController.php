...
class ProfessionalController extends Controller
{
    ...
    public function signup_success(Request $request)
    {
        ...
        $professional->save();
        return response()->json(['success'=>'You have signed up as a professional!! Please wait to get verified'], 200);
    ...
    public function makeVerified($id)
    {
        ...
        return response()->json(['success'=>'Account is verified and Mail Sent.'], 200);
    }
    ...
    public function loginVerification(Request $request)
    {
        ...
        if(!empty($professional)){
            ...
            return response()->json(['error'=>'Email Not Registered...'], 200);
        ...
        if($professional->verification_status =='1')
        {
            ...
            return response()->json(['error'=>'You are yet not verified...'], 200);
    ...
    public function dashboard($id)
    {
        ...
        return response()->json($professional, 200, $headers);
    ...
    public function service_order($id)
    {
        ...
        return response()->json(['orders' => $orders,'professional' => $professional], 200);
    ...
    public function accept_order(Request $request)
    {
        ...
        $service_order->save();
        return response()->json(['success'=>'Service request accepted by you'], 200);
    ...
    public function reject_order(Request $request)
    {
        ...
        $service_order->save();
        return response()->json(['error'=>'You just declined a service order'], 200);
...
//        $id=$request->professional_id;
        ...
        return response()->json(['success'=>'Service Marked as completed'], 200);
    ...
    public function professional_commission(){
        ...
        return response()->json(['commission' => $commussion], 200);
    ...
    public function update_professional_commission(Request $request){
        ...
        return response()->json(['success','commission updated'], 200, $headers);
    ...
    public function wallet($id)
    {
        ...
        $professional=Professional::find($id);
        $commission=ProfessionalCommission::find(1);
        return response()->json(['orders' => $orders,'professional' => $professional,'commission' => $commision], 200);

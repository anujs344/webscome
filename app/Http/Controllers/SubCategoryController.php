...
class SubCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.sub_categories.index')->with('sub_categories',$sub_categories);
    }
    ...
    public function create()
    {
        ...
        return view('admin.sub_categories.create')->with('parent_categories',$parent_categories);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/subCat')->with('success','SUb-Category created');
    }
    ...
    public function edit($id)
    {
        ...
        //return $category;
        return view('admin.sub_categories.edit')->with('category',$category)->with('parent_categories',$parent_categories);
    }
    ...
    public function destroy($id)
    {
        ...
        $sub_category->delete();
        return redirect('/subCat')->with('success','Sub Category Removed successfully.');
    }
}
